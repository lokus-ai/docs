...
description: Infinite digital whiteboard powered by TLDraw for visual thinking, diagram creation, and spatial note organization. Features auto-save, version history, drawing tools, and note integration.
keywords: [lokus canvas, whiteboard, visual thinking, diagrams, tldraw, infinite canvas, drawing tools, visual organization]
---
...
Version 1.3 brings critical reliability improvements and powerful new drawing capabilities:
