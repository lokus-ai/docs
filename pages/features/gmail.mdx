---
title: Gmail Integration - Email Workflow Integration
description: Secure Gmail integration with OAuth 2.0 + PKCE authentication. Import emails as notes, preserve threading, manage attachments, and search emails within Lokus with privacy-focused local processing.
keywords: [gmail integration, email import, oauth authentication, email notes, email workflow, secure authentication, email search]
---
...
-**Secure Token Storage** - Keychain (macOS), Credential Manager (Windows)
-**Import emails as notes** with full formatting preservation
-**Preserve threading** and conversation context
-**Attachment handling** with local storage and deduplication
-**Email search** within Lokus using full-text search
-**Two-way sync** (optional) with conflict resolution
...
-**Hybrid redirect** - Deep links + localhost fallback for auth
