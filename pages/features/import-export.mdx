...
4. Configure import options:
   ...
   ✓ Convert plugins to Lokus equivalents
5. Click "Import"
```
...
**Compatibility Notes:**
```
✓ Wiki links: [[note]] → Fully compatible
✓ Embeds: ![[note]] → Converted
✓ Tags: #tag → Compatible
✓ Callouts: >[!note] → Compatible
✓ Math: $$ equations $$ → Compatible
✗ Dataview queries: Manual conversion needed
✗ Custom plugins: Check Lokus plugin library
```
...
3. Configure:
   ...
   ✓ Import databases as Lokus Bases
   ✓ Convert properties to frontmatter
...
3. Configure:
   ...
   ✓ Maintain daily notes structure
   ✓ Convert page links to wiki links
   ✓ Import block embeds as quotes
4. Import
```
...
✗ Math equations (converted to images)
✗ Custom callouts (converted to quotes)
```
...
2. Options:
   ✓ Preserve wiki links or convert to standard
   ✓ Include frontmatter
   ✓ Relative or absolute image paths
   ✓ Line break style (\\n or <br>)
3. Export
```
