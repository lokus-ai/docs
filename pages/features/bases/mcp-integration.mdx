...
2. Or navigate to: **Preferences → MCP Server → Status**
   - Status should show: `✓ Running on port 3000`
...
> **⚠️ Warning:** Changing the default port may require updating AI assistant configurations.
...
> **⚠️ Warning:** Property updates modify your markdown files directly. Ensure you have backups or version control!
...
**AI Response:**
```
✓ Updated 12 tasks in Design project to Done status
...
**AI Response:**
```
✓ Created view "This Week" in Tasks base
...
**AI Response:**
```
✓ Exported 24 active projects to CSV
