...
> **Warning:** Using the root folder `/` as a source in large workspaces (5,000+ notes) may slow performance. Use specific folders or enable [Quantum Search](#quantum-search-integration) for better performance.
