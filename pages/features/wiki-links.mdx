---
title: Wiki Links & Backlinks - Connected Note-Taking
description: Bidirectional linking system with wiki links [[Note Name]] syntax, automatic backlinks, fuzzy search autocomplete, and real-time updates. Foundation of connected knowledge management in Lokus.
keywords: [wiki links, backlinks, bidirectional links, note linking, connected notes, knowledge graph, autocomplete]
---
