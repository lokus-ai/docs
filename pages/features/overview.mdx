---
title: Features Overview - Complete Guide to Lokus Capabilities
description: Comprehensive overview of all Lokus features including rich text editing, wiki links, graph visualization, task management, search, templates, themes, and integrations for powerful knowledge management.
keywords: [lokus features, knowledge management features, note-taking features, wiki links, graph visualization, task management, markdown editor]
---
