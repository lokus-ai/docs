---
title: Task Management - Kanban Boards and Task Tracking
description: Comprehensive task management system with Kanban boards, keyboard-first workflow, batch operations, and HashMap backend for 10x faster performance. Track tasks and projects directly in your notes.
keywords: [lokus tasks, task management, kanban board, todo list, project management, keyboard shortcuts, batch operations]
---
...
- [ ] Write documentation @sarah #docs !medium  2024-03-22  2h
