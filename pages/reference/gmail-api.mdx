---
title: Gmail Integration API Reference
description: Complete API reference for Gmail integration in Lokus covering OAuth authentication, email operations, sending/receiving messages, label management, and operation queues for offline support.
keywords: [lokus, gmail api, email integration, oauth authentication, email operations, gmail sync, email management, api reference]
---
