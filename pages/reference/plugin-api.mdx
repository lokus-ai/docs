...
description: Complete Plugin API reference for Lokus covering plugin structure, editor manipulation, UI components, filesystem operations, settings management, event system, and permission controls for safe plugin development.
keywords: [lokus, plugin api, plugin development, editor api, filesystem api, plugin permissions, event system, api reference]
---
