---
title: API Overview
description: High-level overview of Lokus API architecture spanning Tauri backend, frontend JavaScript, plugin system, and MCP server with comprehensive API categories and invocation patterns.
keywords: [lokus, api overview, tauri commands, plugin api, mcp server, api architecture, javascript api, backend api]
---
