...
description: Complete reference for all Tauri backend commands in Lokus covering file operations, workspace management, plugin system, MCP server, Gmail integration, task management, search, clipboard, and platform services.
keywords: [lokus, tauri commands, backend api, rust commands, file operations, workspace management, plugin commands, api reference]
---
