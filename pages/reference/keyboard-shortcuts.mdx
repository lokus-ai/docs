...
description: Complete keyboard shortcuts reference for Lokus covering file operations, editing, formatting, navigation, view management, and customization options for macOS, Windows, and Linux platforms.
keywords: [lokus, keyboard shortcuts, hotkeys, keybindings, shortcut customization, productivity, navigation shortcuts, editor shortcuts]
---
