...
description: Complete guide to integrating AI assistants with Lokus using MCP covering built-in server auto-start, 68+ tools, stdio/HTTP transports, connection methods, and integration patterns.
keywords: [lokus, ai assistant, mcp integration, ai connection, stdio transport, http transport, mcp server, assistant integration]
---
