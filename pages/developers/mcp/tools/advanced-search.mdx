---
title: Advanced Search Tools Reference
description: Complete reference for 16 advanced search MCP tools powered by Quantum Superposition Index with sub-millisecond latency, semantic search, filters, fuzzy matching, and complex queries.
keywords: [lokus, advanced search, quantum search, semantic search, mcp tools, full-text search, search filters, fuzzy matching]
---
