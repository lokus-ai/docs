...
description: Complete MCP prompts reference covering prompt structure, templates, argument handling, message formatting, multi-step prompts, and best practices for AI assistant interactions.
keywords: [lokus, mcp prompts, prompt templates, ai prompts, prompt engineering, message formatting, template variables, mcp reference]
---
