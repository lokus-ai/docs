---
title: MCP Overview
description: Comprehensive Model Context Protocol overview covering JSON-RPC 2.0 architecture, resources, tools, prompts, plugin integration, security model, transports, and performance optimizations.
keywords: [lokus, mcp, model context protocol, json-rpc, ai integration, protocol specification, mcp architecture, mcp resources]
---
