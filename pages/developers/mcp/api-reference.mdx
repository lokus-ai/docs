...
description: Complete MCP API reference covering MCPProtocol, MCPClient, MCPServerHost, MCPPluginManager classes with type definitions, events, methods, builder classes, and usage examples.
keywords: [lokus, mcp api, api reference, mcp protocol, mcp client, mcp server, type definitions, mcp events]
---
