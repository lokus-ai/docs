...
description: Complete plugin manifest reference covering metadata, activation events, permissions, contribution points, commands, keybindings, configuration, themes, and dependencies for Lokus plugin development.
keywords: [lokus, plugin manifest, plugin.json, plugin configuration, activation events, permissions, contribution points, plugin development]
---
...
- `editor:extensions` - Register TipTap extensions
...
- `workspace:files` - Access workspace files

**UI Permissions:**
- `ui:create` - Create UI elements (panels, dialogs)
- `ui:modify` - Modify existing UI
- `ui:notifications` - Show notifications
- `ui:statusBar` - Add status bar items
- `ui:treeView` - Register tree views
...
- `terminal:sendText` - Send text to terminals
- `terminal:close` - Close terminals

**Task Permissions:**
- `tasks:register` - Register task providers
- `tasks:execute` - Execute tasks

**Debug Permissions:**
- `debug:start` - Start debug sessions
- `debug:stop` - Stop debug sessions
- `debug:register` - Register debug adapters

**Theme Permissions:**
- `theme:register` - Register color themes
- `theme:modify` - Modify theme colors

**Language Permissions:**
- `languages:register` - Register language features
- `languages:completion` - Provide completions
- `languages:hover` - Provide hover information
- `languages:formatting` - Provide formatting
...
Create custom views and tree views.
...
- `priority` - Position order (higher = more left/right)
- `text` - Display text (supports codicons: `$(icon-name)`)
...
**Fields:**
- `id` - Unique tree view identifier
- `name` - Display name
- `viewId` - Container view ID
- `canSelectMany` - Allow multi-selection
- `showCollapseAll` - Show collapse all button
